...
const ABI = require("../artifacts/contracts/lord.sol/lord.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("lord");
  const nft = await NFT.attach("0x14F963d0089f44CE8B1D785D4F201Fa8Bda20b5c");
